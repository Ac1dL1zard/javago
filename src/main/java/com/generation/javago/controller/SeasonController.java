...
public class SeasonController
{
	...
	@PostMapping("seasons")
	public GenericSeasonDTO insert(@RequestBody GenericSeasonDTO seasonDTO)
	{
		Season toInsert= seasonDTO.convertToSeason(); 
		if(!toInsert.isValid())
			throw new InvalidEntityException("Invalid season data");
		
		return new GenericSeasonDTO(repo.save(toInsert)); 
	}
}
